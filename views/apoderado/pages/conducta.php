            ...
            <div class="container__conductas">
                <div class="section_conductas_bimestre1 sec_1">
                    <div class="conductas_contain">
                        ...
                        <button id="btn_1" onclick="btnActivate(1)" class="toggle-button"><i class="fas fa-chevron-right" aria-hidden="true"></i></button>
                    </div>
                </div>
                <div class="section_conductas_bimestre1 sec_2">
                    <div class="conductas_contain">
                        ...
                        <button id="btn_2" onclick="btnActivate(2)" class="toggle-button"><i class="fas fa-chevron-right" aria-hidden="true"></i></button>
                    </div>
                </div>
                <div class="section_conductas_bimestre1 sec_3">
                    <div class="conductas_contain">
                        ...
                        <button id="btn_3" onclick="btnActivate(3)" class="toggle-button"><i class="fas fa-chevron-right" aria-hidden="true"></i></button>
                    </div>
                </div>
            </div>
        </div>
