            ...
            <form action="/views/director/pages/editarapoderado.php" method="POST" class="form__container">
                <div class="form__contrataciones">
                    <div class="form-group">
                        ...
                        <input disabled selected type="text" id="apoderado_id" name="apoderado_id" value="<?= htmlspecialchars($apoderado[0]['apoderado_id']) ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="dni">DNI:</label>
                        <input type="text" id="dni" name="dni" value="<?= htmlspecialchars($apoderado[0]['dni']) ?>" onkeydown="return soloNumeros(event)" minlength="8" maxlength="8" required>
                        <script src="/views/director/js/home.js"></script>
                    </div>
                    <div class="form-group">
                        <label for="nombres">Nombres:</label>
                        <input type="text" id="nombres" name="nombres" value="<?= htmlspecialchars($apoderado[0]['nombres']) ?>" onkeydown="return soloLetras(event)" maxlength="50" required>
                        <script src="/views/director/js/home.js"></script>
                    </div>
                    <div class="form-group">
                        <label for="apellidos">Apellidos:</label>
                        <input type="text" id="apellidos" name="apellidos" value="<?= htmlspecialchars($apoderado[0]['apellidos']) ?>" onkeydown="return soloLetras(event)" maxlength="50" required>
                        <script src="/views/director/js/home.js"></script>
                    </div>
                    <div class="form-group">
                        <label for="genero">Género:</label>
                        <input type="text" id="genero" name="genero" value="<?= htmlspecialchars($apoderado[0]['genero']) ?>" onkeydown="return soloLetras(event)" required>
                        <script src="/views/director/js/home.js"></script>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="telefono" name="telefono" value="<?= htmlspecialchars($apoderado[0]['telefono']) ?>" onkeydown="return soloNumeros(event)" minlength="9" maxlength="9" required>
                        <script src="/views/director/js/home.js"></script>
                    </div>
                    <div class="form-group">
                        <label for="seccion">Correo:</label>
                        <input type="text" id="correo" name="correo" value="<?= htmlspecialchars($apoderado[0]['correo']) ?>" maxlength="50" required>
                    </div>
                </div>
